          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            {contactInfoStatus.loading ? (
              ...
              <div className="text-center p-8 bg-slate-50 rounded-xl border border-slate-100">
                <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center rounded-full bg-slate-100 text-slate-400">
                  <MapPin size={28} />
                </div>
                ...
                <p className="text-slate-500 text-sm mb-4 max-w-sm mx-auto">
                  ...
                  Vous pouvez toutefois utiliser le formulaire ci-contre pour
                  nous écrire.
                </p>
                <button
                ...
                >
                  <Loader2
                    size={16}
                    className={contactInfoStatus.loading ? "animate-spin" : ""}
                  />
                  Réessayer
                </button>
              </div>
