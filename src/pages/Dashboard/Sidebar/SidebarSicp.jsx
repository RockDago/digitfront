...
export default function SidebarSicp({
  ...
  // --- MENU CONFIGURATION PAR SECTIONS ---
  const navSections = [
    {
      ...
      items: [
        ...
        {
          to: "/dashboard/sicp/planification-descente",
          label: "Planification descente",
          icon: FaCalendarAlt,
        },
        {
          to: "/dashboard/sicp/geolocalisation",
  ...
  return (
    <>
      ...
      >
        ...
        {/* NAVIGATION LIST (Gérée dynamiquement par section) */}
        <nav className="flex-1 overflow-y-auto custom-scrollbar pb-6">
          {navSections.map((section, index) => (
            <div key={index} className="mb-6">
              {/* Titre de la section (masqué si collapsed) */}
              {!collapsed && (
