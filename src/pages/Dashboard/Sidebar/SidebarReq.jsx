...
export default function SidebarReq({
  isSidebarCollapsed,
  toggleSidebar,
  isMobileOpen,
  setIsMobileOpen,
}) {
  const [activeState, setActiveState] = useState("tableau");
  ...
  const navItems = [
    ...
    {
      to: "/dashboard/requerant/creer-demande",
      icon: FaRegFileAlt,
  ...
  const isLinkActive = (path) =>
    ...
    (path === "/dashboard/requerant" &&
      location.pathname === "/dashboard/requerant/");
