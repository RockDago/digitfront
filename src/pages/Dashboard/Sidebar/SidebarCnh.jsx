...
import {
  FaBars,
  FaTimes,
  FaTachometerAlt, // Icône style "tableau de bord voiture"
  FaRegFileAlt,
  FaFolderOpen,
  FaMoon,
  FaSun,
...
export default function SidebarCnh({
  ...
  const navItems = [
      ...
      items: [
        {
          ...
          icon: FaTachometerAlt, // Icône changée ici
    ...
    },
    {
      items: [
        {
          to: "/dashboard/cnh/listes-demandes-habilitations",
          icon: FaRegFileAlt,
          label: "Listes des demandes d'habilitations",
        },
        {
          to: "/dashboard/cnh/archives-demandes",
          icon: FaFolderOpen,
        ...
        <div className="h-20 flex items-center justify-center px-6 border-b border-gray-50 dark:border-gray-800 mb-4 relative">
          {!collapsed && (
            <div
              ...
              onClick={() => goTo("/dashboard/cnh/tableau-de-bord")}
            >
        ...
        <nav className="flex-1 overflow-y-auto custom-scrollbar pb-6">
          {navItems.map((section, sectionIndex) => (
            <div key={sectionIndex} className="mb-2">
              {/* Titres de sections supprimés ici */}
