...
const CreerDemandeAccreditation = () => {
  ...
  useEffect(() => {
    ...
    if (currentUserId) {
      const savedResult = localStorage.getItem(
        `autoevaluationresult_${currentUserId}`,
      );
      if (savedResult) {
        try {
          ...
          if (result.formData?.criteres) {
            ...
            const criteresList = Object.entries(result.formData.criteres).map(
              ([id, data]) => ({
                id,
  ...
  const handleOpenRecap = (e) => {
    ...
    if (formData.typeetablissement === "Publique") {
      requiredFields.push("etablissement");
    } else if (formData.typeetablissement === "Privée") {
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b-2 border-slate-200 dark:border-slate-700">
                <th className="text-left py-3 px-2 font-semibold text-slate-700 dark:text-slate-200">
                  Niveau
                </th>
                <th className="text-left py-3 px-2 font-semibold text-slate-700 dark:text-slate-200">
                  Plage de points
        ...
        <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs text-blue-700 dark:text-blue-200">
              ...
              Score de {lastEvaluation.score}/368 - Niveau{" "}
              <span className="font-bold">
                {levelConfig[getLevelFromScore(lastEvaluation.score)].label}
              </span>
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center w-full space-y-6">
        <div className="w-full bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-lg">
          <div className="flex items-center justify-between mb-6">
            ...
            <div
              className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold ${levelConfig[currentLevel].badge}`}
            >
          ...
          <div className="relative mt-8 mb-10">
              ...
              {thresholds.map((threshold, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className="text-[11px] font-bold mt-1.5 px-1.5 py-0.5 bg-white dark:bg-slate-900 rounded-md border"
                      style={{
            ...
            >
              <div className="relative">
                <div className="w-6 h-6 bg-white dark:bg-slate-900 border-4 border-slate-900 dark:border-slate-100 rounded-full shadow-lg"></div>
        ...
        <div className="grid grid-cols-5 gap-3 mt-8">
          <div className="flex flex-col items-center p-3 bg-white dark:bg-gray-900 rounded-xl border border-red-200 hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-col items-center p-3 bg-white dark:bg-gray-900 rounded-xl border border-orange-200 hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-col items-center p-3 bg-white dark:bg-gray-900 rounded-xl border border-yellow-200 hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-col items-center p-3 bg-white dark:bg-gray-900 rounded-xl border border-blue-200 hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-col items-center p-3 bg-white dark:bg-gray-900 rounded-xl border border-green-200 hover:shadow-md transition-shadow">
  ...
  const DetailCriteresSection = () => {
    if (!autoEvaluationResult || !criteresDetails) {
      return (
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-6 text-center">
          ...
          <h4 className="text-lg font-semibold text-yellow-800 dark:text-yellow-100 mb-2">
    ...
    const formationCriteres = Object.entries(criteresDetails).filter(
      ([id]) => id.includes("critere") && parseInt(id.split("_")[1]) <= 37,
    );

    const gouvernanceCriteres = Object.entries(criteresDetails).filter(
      ([id]) =>
        id.includes("critere") &&
        parseInt(id.split("_")[1]) >= 38 &&
        parseInt(id.split("_")[1]) <= 88,
    );

    const rechercheCriteres = Object.entries(criteresDetails).filter(
      ([id]) => id.includes("critere") && parseInt(id.split("_")[1]) >= 89,
    );

    const formationScore = formationCriteres.reduce(
      (acc, [, data]) => acc + (parseInt(data.note) || 0),
      0,
    );
    const gouvernanceScore = gouvernanceCriteres.reduce(
      (acc, [, data]) => acc + (parseInt(data.note) || 0),
      0,
    );
    const rechercheScore = rechercheCriteres.reduce(
      (acc, [, data]) => acc + (parseInt(data.note) || 0),
      0,
    );
    ...
    return (
      <div className="space-y-6">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="px-3 py-1.5 bg-white/20 backdrop-blur-sm rounded-full text-xs font-medium">
              {new Date(autoEvaluationResult.timestamp).toLocaleDateString(
                "fr-FR",
                {
                  day: "2-digit",
                  month: "2-digit",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full ${niveauConfig.bar}`}
                ></div>
        ...
        {!eligible && (
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl p-5 shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-red-800 dark:text-red-100 mb-1">
                  Demande non éligible
                </p>
                <p className="text-sm text-red-700 dark:text-red-200">
                  Votre établissement a obtenu un niveau{" "}
                  <strong>{niveauConfig.label}</strong>. Seuls les niveaux{" "}
                  <strong>Acceptable</strong>, <strong>Satisfaisant</strong> et{" "}
                  <strong>Excellent</strong> sont éligibles à la soumission
                  d'une demande d'accréditation.
                </p>
                <p className="text-sm text-red-700 dark:text-red-200 mt-2">
                  Veuillez améliorer votre score via l'auto-évaluation avant de
        ...
        <div
          className={`${niveauConfig.color} border ${niveauConfig.badge} rounded-xl p-5 shadow-sm`}
        >
          <div className="flex items-start gap-3">
            <div className={`p-2 rounded-lg ${niveauConfig.badge.split(" ")[0]}`}>
              {React.createElement(niveauConfig.icon, {
                className: `w-5 h-5 ${niveauConfig.badge.split(" ")[1]}`,
              })}
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start mb-3">
              ...
              <span
                className={`text-xs px-2 py-1 rounded-full ${
                  levelConfig[getLevelFromScore(formationScore)].badge
                }`}
              >
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 mb-3">
              <div
                className={`h-2.5 rounded-full ${
                  levelConfig[getLevelFromScore(formationScore)].bar
                }`}
            ...
            <div className="flex items-center gap-1">
              ...
              ></div>
              <span className="text-xs text-gray-600 dark:text-gray-300">
                {formationCriteres.length} critères
              </span>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start mb-3">
              ...
              <span
                className={`text-xs px-2 py-1 rounded-full ${
                  levelConfig[getLevelFromScore(gouvernanceScore)].badge
                }`}
              >
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 mb-3">
              <div
                className={`h-2.5 rounded-full ${
                  levelConfig[getLevelFromScore(gouvernanceScore)].bar
                }`}
            ...
            <div className="flex items-center gap-1">
              ...
              ></div>
              <span className="text-xs text-gray-600 dark:text-gray-300">
                {gouvernanceCriteres.length} critères
              </span>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start mb-3">
              ...
              <span
                className={`text-xs px-2 py-1 rounded-full ${
                  levelConfig[getLevelFromScore(rechercheScore)].badge
                }`}
              >
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 mb-3">
              <div
                className={`h-2.5 rounded-full ${
                  levelConfig[getLevelFromScore(rechercheScore)].bar
                }`}
            ...
            <div className="flex items-center gap-1">
              ...
              ></div>
              <span className="text-xs text-gray-600 dark:text-gray-300">
                {rechercheCriteres.length} critères
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="p-5 md:p-6 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-900 z-10">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-3">
                    <div className="flex items-start">
                      <span className="text-sm font-medium text-gray-600 dark:text-gray-300 w-36">
                        Numéro de demande :
                      </span>
                      <span className="text-sm font-semibold text-blue-600">
                        {numeroDemande || "ACC-202602-0001"}
                      </span>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <span className="text-sm text-gray-900 dark:text-gray-100">
                        {formData.typeetablissement || "Publique"}
                      </span>
                    </div>
                    ...
                    {formData.typeetablissement === "Privée" && (
                      <div className="flex items-start">
                        <span className="text-sm font-medium text-gray-600 dark:text-gray-300 w-36">
                          Institution :
                        </span>
          ...
          <div className="px-5 py-6">
            <div className="flex items-center mb-6">
              <button
                ...
                className="text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white mr-4"
              >
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-6 py-8 md:py-12">
          <div className="space-y-8 md:space-y-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-6">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl md:rounded-2xl border border-slate-200 dark:border-slate-700 md:shadow-lg p-5 md:p-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4 shadow-sm border border-slate-100 dark:border-slate-700">
                      ...
                      <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${
                              (lastEvaluation.policies[0].totalScore /
                                lastEvaluation.policies[0].maxScore) *
                              100
                            }%`,
                          }}
                        ></div>
                      ...
                      <div className="flex justify-between items-center mt-2">
                        <span className="text-xs text-gray-600 dark:text-gray-300">
                          Score : {lastEvaluation.policies[0].totalScore}/
                          {lastEvaluation.policies[0].maxScore}
                        </span>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4 shadow-sm border border-slate-100 dark:border-slate-700">
                      ...
                      <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${
                              (lastEvaluation.policies[1].totalScore /
                                lastEvaluation.policies[1].maxScore) *
                              100
                            }%`,
                          }}
                        ></div>
                      ...
                      <div className="flex justify-between items-center mt-2">
                        <span className="text-xs text-gray-600 dark:text-gray-300">
                          Score : {lastEvaluation.policies[1].totalScore}/
                          {lastEvaluation.policies[1].maxScore}
                        </span>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4 shadow-sm border border-slate-100 dark:border-slate-700">
                      ...
                      <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${
                              (lastEvaluation.policies[2].totalScore /
                                lastEvaluation.policies[2].maxScore) *
                              100
                            }%`,
                          }}
                        ></div>
                      ...
                      <div className="flex justify-between items-center mt-2">
                        <span className="text-xs text-gray-600 dark:text-gray-300">
                          Score : {lastEvaluation.policies[2].totalScore}/
                          {lastEvaluation.policies[2].maxScore}
                        </span>
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-lg border border-blue-200 dark:border-blue-700 shadow-sm">
                      <div className="flex justify-between items-center mb-3">
                        ...
                        <span className="text-xl font-bold text-blue-700 dark:text-blue-100">
                          {lastEvaluation.policies.reduce(
                      ...
                      <div className="w-full bg-blue-100 dark:bg-blue-900 rounded-full h-2.5 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(lastEvaluation.score / 368) * 100}%`,
                          }}
                        ></div>
                      </div>
                      ...
                      <div className="flex justify-end mt-2">
                        <span className="text-xs bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-200 px-3 py-1 rounded-full font-medium">
                          Niveau :{" "}
                          {
                            levelConfig[getLevelFromScore(lastEvaluation.score)]
                              .label
                          }
                        </span>
                      </div>
            ...
            <NiveauxInstitutionnelsTable
              currentLevel={getLevelFromScore(lastEvaluation.score)}
            />
            ...
            <div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl md:rounded-2xl border border-slate-200 dark:border-slate-700 md:shadow-lg p-5 md:p-6 mb-6 md:mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-2 pb-2 border-b border-gray-100 dark:border-gray-700">
                      <strong className="text-slate-700 dark:text-slate-200 text-sm min-w-[140px]">
                        Numéro de demande :
                      </strong>
