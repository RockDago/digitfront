...
export default function SidebarSicp({
  collapsed,
  setCollapsed,
  isMobileOpen,
  setIsMobileOpen,
  ...
  // États accordéons
  const [suiviInterneOpen, setSuiviInterneOpen] = useState(false);
  const [suiviQualiteOpen, setSuiviQualiteOpen] = useState(false);
  ...
  const suiviInterneItems = [
    { label: "Avant descente", path: "/dashboard/sicp/avant-descente" },
    { label: "Après descente", path: "/dashboard/sicp/apres-descente" },
  ];
          ...
          <div className="mb-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                />
                {!collapsed && <span>Géolocalisation</span>}
              </div>
            </div>
          </div>
